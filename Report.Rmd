...
From the ROC curve, we can observe the random forest model has the largest AUC (area under curve) and also the greatest sensitivity or smallest FNR. Therefore random forest model should be chosen as the most appropriate model for this case. Below is the summary of sensitivity with the three machine learning models.
